...
var rows = ["012","210","345","543","678","876","036","630","147","741","258","825","840","048","246","642","021","354","687","084","258","036","174","285"];
    ...
    if(turn === 1 && document.getElementById("bot").value === "cpu"){
      ...
      switch(document.getElementById("difficulty").value){
        ...
        case "hard":
          ...
          console.log(t);
          if(!posible.includes(t)) t = posible[Math.round(Math.random()*posible.length*0.99)];
          console.log(t);
          console.log(posible);
          cell(t);
        break;
